...
/* Sidebar - tot el text visible */
div[data-testid="stSidebar"] *{color:#1a2744!important;}
...
div[data-testid="stSidebar"] span{color:#1a2744!important;}

/* Expanders (detall complet, etc.) */
details, details *,
summary, summary *,
